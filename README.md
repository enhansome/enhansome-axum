...
[repository](https://github.com/tokio-rs/axum) ⭐ 27,176 | 🐛 75 | 🌐 Rust | 📅 2026-09-18

This page contains a list of axum-related crates, project showcases, tutorials, videos, and other assorted items.

It started as a copy of the `ECOSYSTEM.md` file of the [repository of axum](https://github.com/tokio-rs/axum) ⭐ 27,176 | 🐛 75 | 🌐 Rust | 📅 2026-09-18 when it was [removed](https://github.com/tokio-rs/axum/pull/3737) ⭐ 27,176 | 🐛 75 | 🌐 Rust | 📅 2026-09-18. After a brief maintenance as part of the 📖 [Code Maven axum book](https://axum.code-maven.com/) it was moved to the 🎉 [awesome axum](https://github.com/szabgab/awesome-axum) ⭐ 108 | 🐛 0 | 📅 2026-05-07 repository.
...
* [loco.rs](https://github.com/loco-rs/loco) ⭐ 9,153 | 🐛 18 | 🌐 Rust | 📅 2026-09-16: A full stack Web and API productivity framework similar to Rails, based on axum.
...
* [zino](https://github.com/zino-rs/zino) ⭐ 1,150 | 🐛 8 | 🌐 Rust | 📅 2026-09-18: Zino is a next-generation framework for composable applications which provides full integrations with axum.
...
* [crates.io](https://crates.io/) itself uses axum as a web library and [diesel](https://crates.io/crates/diesel) for database access.  [GitHub](https://github.com/rust-lang/crates.io/) ⭐ 3,700 | 🐛 115 | 🌐 Rust | 📅 2026-09-19  (axum 0.8.9)
...
* [wastebin](https://github.com/matze/wastebin) ⭐ 858 | 🐛 19 | 🌐 Rust | 📅 2026-09-18: A minimalist pastebin service. (axum 0.8)
...
* [KeyCompute](https://github.com/aiqubits/keycompute) ⭐ 218 | 🐛 1 | 🌐 Rust | 📅 2026-09-19: KeyCompute is a high-performance, scalable, and ready-to-use AI computing power service platform. (axum 0.8; added on 2026.04.27)
...
* [CLOMonitor](https://clomonitor.io) ([repository](https://github.com/cncf/clomonitor) ⭐ 149 | 🐛 25 | 🌐 Rust | 📅 2026-09-18): Checks open source projects repositories to verify they meet certain best practices. (axum 0.8.8)
...
* [tower-mcp](https://github.com/joshrotenberg/tower-mcp) ⭐ 10 | 🐛 14 | 🌐 Rust | 📅 2026-09-18: Tower-native Model Context Protocol (MCP) implementation. (axum 0.8)
* [xidl](https://github.com/xidl/xidl) ⭐ 9 | 🐛 2 | 🌐 Rust | 📅 2026-09-19: Using axum just like tonic, declare IDL, then generate server, client and OpenAPI. (axum 0.8; added on 2026.04.27)
...
* [Svix](https://www.svix.com) ([repository](https://github.com/svix/svix-webhooks) ⭐ 3,407 | 🐛 61 | 🌐 Rust | 📅 2026-09-18): Enterprise-ready webhook service. (axum 0.7.9)
* [realworld-axum-sqlx](https://github.com/launchbadge/realworld-axum-sqlx) ⭐ 1,106 | 🐛 14 | 🌐 Rust | 📅 2023-12-30: A Rust implementation of the [Realworld](https://github.com/gothinkster/realworld) ⭐ 84,223 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-26 demo app spec using axum and [SQLx](https://crates.io/crates/sqlx). (axum 0.3.4) See [fork](https://github.com/davidpdrsn/realworld-axum-sqlx) ⭐ 239 | 🐛 2 | 🌐 Rust | 📅 2024-07-25 with newer dependencies. (axum 0.7.3)
