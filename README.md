...
[repository](https://github.com/tokio-rs/axum) ⭐ 26,931 | 🐛 75 | 🌐 Rust | 📅 2026-08-20

This page contains a list of axum-related crates, project showcases, tutorials, videos, and other assorted items.

It started as a copy of the `ECOSYSTEM.md` file of the [repository of axum](https://github.com/tokio-rs/axum) ⭐ 26,931 | 🐛 75 | 🌐 Rust | 📅 2026-08-20 when it was [removed](https://github.com/tokio-rs/axum/pull/3737) ⭐ 26,931 | 🐛 75 | 🌐 Rust | 📅 2026-08-20. After a brief maintenance as part of the 📖 [Code Maven axum book](https://axum.code-maven.com/) it was moved to the 🎉 [awesome axum](https://github.com/szabgab/awesome-axum) ⭐ 109 | 🐛 0 | 📅 2026-05-07 repository.
...
* [loco.rs](https://github.com/loco-rs/loco) ⭐ 9,088 | 🐛 13 | 🌐 Rust | 📅 2026-08-19: A full stack Web and API productivity framework similar to Rails, based on axum.
* [socketioxide](https://github.com/totodore/socketioxide) ⭐ 1,622 | 🐛 14 | 🌐 Rust | 📅 2026-08-23: An easy to use socket.io server implementation working as a `tower` layer/service.
* [zino](https://github.com/zino-rs/zino) ⭐ 1,144 | 🐛 8 | 🌐 Rust | 📅 2026-08-19: Zino is a next-generation framework for composable applications which provides full integrations with axum.
...
* [tower-resilience](https://github.com/joshrotenberg/tower-resilience) ⭐ 101 | 🐛 0 | 🌐 Rust | 📅 2026-08-23: Resilience middleware for tower: circuit breaker, bulkhead, retry, rate limiter, and more.
...
* [crates.io](https://crates.io/) itself uses axum as a web library and [diesel](https://crates.io/crates/diesel) for database access.  [GitHub](https://github.com/rust-lang/crates.io/) ⭐ 3,681 | 🐛 117 | 🌐 Rust | 📅 2026-08-24  (axum 0.8.9)
...
* [ReductStore](https://github.com/reductstore/reductstore) ⭐ 368 | 🐛 17 | 🌐 Rust | 📅 2026-08-23: A time series database for storing and managing large amounts of blob data. (axum 0.8.7)
...
* [qiluo-admin](https://github.com/chelunfu/qiluo_admin) ⭐ 232 | 🐛 1 | 🌐 Rust | 📅 2026-07-22 | Axum + SeaORM + JWT + Scheduled + Tasks + SnowId + Redis + Memory + VUE3 | DB: MySQL, Postgres, SQLite. (axum 0.8.9)
...
* [tower-mcp](https://github.com/joshrotenberg/tower-mcp) ⭐ 9 | 🐛 4 | 🌐 Rust | 📅 2026-08-23: Tower-native Model Context Protocol (MCP) implementation. (axum 0.8)
...
* [realworld-axum-sqlx](https://github.com/launchbadge/realworld-axum-sqlx) ⭐ 1,102 | 🐛 14 | 🌐 Rust | 📅 2023-12-30: A Rust implementation of the [Realworld](https://github.com/gothinkster/realworld) ⭐ 84,128 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-13 demo app spec using axum and [SQLx](https://crates.io/crates/sqlx). (axum 0.3.4) See [fork](https://github.com/davidpdrsn/realworld-axum-sqlx) ⭐ 238 | 🐛 2 | 🌐 Rust | 📅 2024-07-25 with newer dependencies. (axum 0.7.3)
