...
[repository](https://github.com/tokio-rs/axum) ⭐ 26,860 | 🐛 76 | 🌐 Rust | 📅 2026-08-11

This page contains a list of axum-related crates, project showcases, tutorials, videos, and other assorted items.

It started as a copy of the `ECOSYSTEM.md` file of the [repository of axum](https://github.com/tokio-rs/axum) ⭐ 26,860 | 🐛 76 | 🌐 Rust | 📅 2026-08-11 when it was [removed](https://github.com/tokio-rs/axum/pull/3737) ⭐ 26,860 | 🐛 76 | 🌐 Rust | 📅 2026-08-11. After a brief maintenance as part of the 📖 [Code Maven axum book](https://axum.code-maven.com/) it was moved to the 🎉 [awesome axum](https://github.com/szabgab/awesome-axum) ⭐ 109 | 🐛 0 | 📅 2026-05-07 repository.
...
* [loco.rs](https://github.com/loco-rs/loco) ⭐ 9,067 | 🐛 26 | 🌐 Rust | 📅 2026-08-05: A full stack Web and API productivity framework similar to Rails, based on axum.
* [socketioxide](https://github.com/totodore/socketioxide) ⭐ 1,619 | 🐛 13 | 🌐 Rust | 📅 2026-08-13: An easy to use socket.io server implementation working as a `tower` layer/service.
* [zino](https://github.com/zino-rs/zino) ⭐ 1,147 | 🐛 8 | 🌐 Rust | 📅 2026-08-10: Zino is a next-generation framework for composable applications which provides full integrations with axum.
* [spring-rs](https://github.com/spring-rs/spring-rs) ⭐ 991 | 🐛 25 | 🌐 Rust | 📅 2026-07-04: spring-rs is a microservice framework written in rust inspired by java's spring-boot, based on axum
* [tower-sessions](https://github.com/maxcountryman/tower-sessions) ⭐ 420 | 🐛 3 | 🌐 Rust | 📅 2026-08-05: Sessions as a `tower` and `axum` middleware.
* [axum-htmx](https://github.com/robertwayne/axum-htmx) ⭐ 271 | 🐛 10 | 🌐 Rust | 📅 2026-01-20: Htmx extractors and request guards for axum.
* [ezsockets](https://github.com/gbaranski/ezsockets) ⭐ 264 | 🐛 13 | 🌐 Rust | 📅 2026-05-18: Easy to use WebSocket library that integrates with axum.
* [axum\_session](https://github.com/AscendingCreations/AxumSessions) ⭐ 203 | 🐛 3 | 🌐 Rust | 📅 2026-08-10: Database persistent sessions like pythons flask\_sessionstore for axum.
...
* [axum-valid](https://github.com/gengteng/axum-valid) ⭐ 166 | 🐛 7 | 🌐 Rust | 📅 2026-06-30: Extractors for data validation using validator, garde, and validify.
* [axum\_session\_auth](https://github.com/AscendingCreations/AxumSessionsAuth) ⭐ 134 | 🐛 1 | 🌐 Rust | 📅 2026-08-10: Persistent session based user login with rights management for axum.
* [tower-resilience](https://github.com/joshrotenberg/tower-resilience) ⭐ 102 | 🐛 1 | 🌐 Rust | 📅 2026-08-09: Resilience middleware for tower: circuit breaker, bulkhead, retry, rate limiter, and more.
* [axum-template](https://github.com/Altair-Bueno/axum-template) ⭐ 97 | 🐛 2 | 🌐 Rust | 📅 2026-04-13: Layers, extractors and template engine wrappers for axum based Web MVC applications
* [AxumKit](https://github.com/levish0/AxumKit) ⭐ 97 | 🐛 12 | 🌐 Rust | 📅 2026-08-02: Production-ready Rust web backend template with authentication, sea-orm (Postgres), SMTP email, Rate limiting with Redis, and deployment.
...
* [axum-streams](https://github.com/abdolence/axum-streams-rs) ⭐ 88 | 🐛 3 | 🌐 Rust | 📅 2026-06-18: Streaming HTTP body with different formats: JSON, CSV, Protobuf.
...
* [axum-keycloak-auth](https://github.com/lpotthast/axum-keycloak-auth) ⭐ 65 | 🐛 17 | 🌐 Rust | 📅 2025-05-18: Protect axum routes with a JWT emitted by Keycloak.
...
* [api-error](https://github.com/centreon/rs-api-error) ⭐ 18 | 🐛 2 | 🌐 Rust | 📅 2026-08-13: A proc macro to define HTTP errors in a thiserror way. It automatically implements `IntoResponse` for your error types. Allowing you to directly return `Result<(), MyError` from your axum handlers.
...
* [Feature Flag Service](https://github.com/webrowse/feature-flag-service-backend/) ⭐ 4 | 🐛 0 | 🌐 Rust | 📅 2026-05-21: A production-ready feature flag management service built with Rust, Axum, and PostgreSQL. (Addedon 2026.04.27)
...
* [crates.io](https://crates.io/) itself uses axum as a web library and [diesel](https://crates.io/crates/diesel) for database access.  [GitHub](https://github.com/rust-lang/crates.io/) ⭐ 3,675 | 🐛 118 | 🌐 Rust | 📅 2026-08-13  (axum 0.8.9)

## 🖼️ Project showcase (axum 0.8.x)

* [ROAPI](https://github.com/roapi/roapi) ⭐ 3,417 | 🐛 66 | 🌐 Rust | 📅 2026-03-25: Create full-fledged APIs for static datasets without writing a single line of code. (axum 0.8)
* [wastebin](https://github.com/matze/wastebin) ⭐ 832 | 🐛 18 | 🌐 Rust | 📅 2026-08-10: A minimalist pastebin service. (axum 0.8)
...
* [ReductStore](https://github.com/reductstore/reductstore) ⭐ 366 | 🐛 14 | 🌐 Rust | 📅 2026-08-08: A time series database for storing and managing large amounts of blob data. (axum 0.8.7)
* [fx](https://github.com/rikhuijzer/fx) ⭐ 325 | 🐛 24 | 🌐 Rust | 📅 2026-08-01: A (micro)blogging server that you can self-host. (axum 0.8)
* [freedit](https://github.com/freedit-org/freedit) ⭐ 313 | 🐛 16 | 🌐 Rust | 📅 2026-07-20: A forum powered by rust. (axum 0.8.7)
* [axum\_admin](https://github.com/lingdu1234/axum_admin) ⭐ 309 | 🐛 8 | 🌐 Rust | 📅 2026-06-24: An admin panel built with **axum**, Sea-orm and Vue 3. (axum 0.8.8)
* [qiluo-admin](https://github.com/chelunfu/qiluo_admin) ⭐ 229 | 🐛 1 | 🌐 Rust | 📅 2026-07-22 | Axum + SeaORM + JWT + Scheduled + Tasks + SnowId + Redis + Memory + VUE3 | DB: MySQL, Postgres, SQLite. (axum 0.8.9)
...
* [clean\_axum\_demo](https://github.com/sukjaelee/clean_axum_demo) ⭐ 199 | 🐛 0 | 🌐 Rust | 📅 2025-08-09: A modern, clean-architecture Rust API server template built with Axum and SQLx. It incorporates domain-driven design, repository patterns, JWT authentication, file uploads, Swagger documentation, OpenTelemetry. (axum 0.8.3)
...
* [KeyCompute](https://github.com/aiqubits/keycompute) ⭐ 178 | 🐛 1 | 🌐 Rust | 📅 2026-07-28: KeyCompute is a high-performance, scalable, and ready-to-use AI computing power service platform. (axum 0.8; added on 2026.04.27)
* [CLOMonitor](https://clomonitor.io) ([repository](https://github.com/cncf/clomonitor) ⭐ 148 | 🐛 24 | 🌐 TypeScript | 📅 2026-07-24): Checks open source projects repositories to verify they meet certain best practices. (axum 0.8.8)
* [axum-rest-api-example](https://github.com/sheroz/axum-rest-api-sample) ⭐ 131 | 🐛 0 | 🌐 Rust | 📅 2026-06-06: REST API Web service in Rust using axum, JSON Web Tokens (JWT), SQLx, PostgreSQL, Redis, Docker, structured error handling, and end-to-end API tests. (axum 0.8)
* [webshelf](https://github.com/aiqubits/webshelf) ⭐ 62 | 🐛 0 | 🌐 Rust | 📅 2026-07-06: 🤘 A convenient way to develop your web service with one click. (axum 0.8.8)
...
* [tower-mcp](https://github.com/joshrotenberg/tower-mcp) ⭐ 9 | 🐛 9 | 🌐 Rust | 📅 2026-08-13: Tower-native Model Context Protocol (MCP) implementation. (axum 0.8)
* [xidl](https://github.com/xidl/xidl) ⭐ 9 | 🐛 0 | 🌐 Rust | 📅 2026-08-12: Using axum just like tonic, declare IDL, then generate server, client and OpenAPI. (axum 0.8; added on 2026.04.27)
...
* [Svix](https://www.svix.com) ([repository](https://github.com/svix/svix-webhooks) ⭐ 3,350 | 🐛 58 | 🌐 Rust | 📅 2026-08-13): Enterprise-ready webhook service. (axum 0.7.9)
* [realworld-axum-sqlx](https://github.com/launchbadge/realworld-axum-sqlx) ⭐ 1,102 | 🐛 14 | 🌐 Rust | 📅 2023-12-30: A Rust implementation of the [Realworld](https://github.com/gothinkster/realworld) ⭐ 84,079 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-13 demo app spec using axum and [SQLx](https://crates.io/crates/sqlx). (axum 0.3.4) See [fork](https://github.com/davidpdrsn/realworld-axum-sqlx) ⭐ 237 | 🐛 2 | 🌐 Rust | 📅 2024-07-25 with newer dependencies. (axum 0.7.3)
...
* [Hatsu](https://github.com/importantimport/hatsu) ⭐ 257 | 🐛 10 | 🌐 Rust | 📅 2025-12-14: 🩵 Self-hosted & Fully-automated ActivityPub Bridge for Static Sites. (axum 0.7)
* [emojied](https://github.com/sekunho/emojied) ⭐ 200 | 🐛 1 | 🌐 Rust | 📅 2025-12-18: Shorten URLs to emojis! (axum 0.6)
...
* [circleci-hook](https://github.com/DavidS/circleci-hook) ⭐ 7 | 🐛 2 | 🌐 Rust | 📅 2023-02-04: Translate CircleCI WebHooks to OpenTelemetry traces to improve your test insights. Add detail with otel-cli to capture individual commands. Use the TRACEPARENT integration to add details from your tests. (axum 0.6.0)
* [httq](https://github.com/scotow/httq) ⭐ 3 | 🐛 0 | 🌐 Rust | 📅 2023-04-17 HTTP to MQTT trivial proxy. (axum 0.6.15)
* [randoku](https://github.com/stchris/randoku) ⭐ 3 | 🐛 8 | 🌐 Rust | 📅 2026-07-24: A tiny web service which generates random numbers and shuffles lists randomly. (axum 0.7)
...
* [demo-rust-axum](https://github.com/joelparkerhenderson/demo-rust-axum) ⭐ 439 | 🐛 0 | 🌐 Rust | 📅 2025-07-13: Demo of Rust and axum
