...
[repository](https://github.com/tokio-rs/axum) ⭐ 26,908 | 🐛 76 | 🌐 Rust | 📅 2026-08-18

This page contains a list of axum-related crates, project showcases, tutorials, videos, and other assorted items.

It started as a copy of the `ECOSYSTEM.md` file of the [repository of axum](https://github.com/tokio-rs/axum) ⭐ 26,908 | 🐛 76 | 🌐 Rust | 📅 2026-08-18 when it was [removed](https://github.com/tokio-rs/axum/pull/3737) ⭐ 26,908 | 🐛 76 | 🌐 Rust | 📅 2026-08-18. After a brief maintenance as part of the 📖 [Code Maven axum book](https://axum.code-maven.com/) it was moved to the 🎉 [awesome axum](https://github.com/szabgab/awesome-axum) ⭐ 109 | 🐛 0 | 📅 2026-05-07 repository.
...
* [loco.rs](https://github.com/loco-rs/loco) ⭐ 9,076 | 🐛 13 | 🌐 Rust | 📅 2026-08-19: A full stack Web and API productivity framework similar to Rails, based on axum.
...
* [zino](https://github.com/zino-rs/zino) ⭐ 1,143 | 🐛 8 | 🌐 Rust | 📅 2026-08-19: Zino is a next-generation framework for composable applications which provides full integrations with axum.
...
* [tower-resilience](https://github.com/joshrotenberg/tower-resilience) ⭐ 101 | 🐛 10 | 🌐 Rust | 📅 2026-08-19: Resilience middleware for tower: circuit breaker, bulkhead, retry, rate limiter, and more.
...
* [crates.io](https://crates.io/) itself uses axum as a web library and [diesel](https://crates.io/crates/diesel) for database access.  [GitHub](https://github.com/rust-lang/crates.io/) ⭐ 3,679 | 🐛 116 | 🌐 Rust | 📅 2026-08-19  (axum 0.8.9)
...
* [wastebin](https://github.com/matze/wastebin) ⭐ 838 | 🐛 17 | 🌐 Rust | 📅 2026-08-17: A minimalist pastebin service. (axum 0.8)
...
* [KeyCompute](https://github.com/aiqubits/keycompute) ⭐ 180 | 🐛 1 | 🌐 Rust | 📅 2026-08-19: KeyCompute is a high-performance, scalable, and ready-to-use AI computing power service platform. (axum 0.8; added on 2026.04.27)
...
* [Svix](https://www.svix.com) ([repository](https://github.com/svix/svix-webhooks) ⭐ 3,359 | 🐛 58 | 🌐 Rust | 📅 2026-08-19): Enterprise-ready webhook service. (axum 0.7.9)
* [realworld-axum-sqlx](https://github.com/launchbadge/realworld-axum-sqlx) ⭐ 1,102 | 🐛 14 | 🌐 Rust | 📅 2023-12-30: A Rust implementation of the [Realworld](https://github.com/gothinkster/realworld) ⭐ 84,107 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-13 demo app spec using axum and [SQLx](https://crates.io/crates/sqlx). (axum 0.3.4) See [fork](https://github.com/davidpdrsn/realworld-axum-sqlx) ⭐ 238 | 🐛 2 | 🌐 Rust | 📅 2024-07-25 with newer dependencies. (axum 0.7.3)
