...
[repository](https://github.com/tokio-rs/axum) ⭐ 26,913 | 🐛 76 | 🌐 Rust | 📅 2026-08-18

This page contains a list of axum-related crates, project showcases, tutorials, videos, and other assorted items.

It started as a copy of the `ECOSYSTEM.md` file of the [repository of axum](https://github.com/tokio-rs/axum) ⭐ 26,913 | 🐛 76 | 🌐 Rust | 📅 2026-08-18 when it was [removed](https://github.com/tokio-rs/axum/pull/3737) ⭐ 26,913 | 🐛 76 | 🌐 Rust | 📅 2026-08-18. After a brief maintenance as part of the 📖 [Code Maven axum book](https://axum.code-maven.com/) it was moved to the 🎉 [awesome axum](https://github.com/szabgab/awesome-axum) ⭐ 109 | 🐛 0 | 📅 2026-05-07 repository.
...
* [loco.rs](https://github.com/loco-rs/loco) ⭐ 9,077 | 🐛 13 | 🌐 Rust | 📅 2026-08-19: A full stack Web and API productivity framework similar to Rails, based on axum.
...
* [tower-resilience](https://github.com/joshrotenberg/tower-resilience) ⭐ 101 | 🐛 4 | 🌐 Rust | 📅 2026-08-19: Resilience middleware for tower: circuit breaker, bulkhead, retry, rate limiter, and more.
...
* [wastebin](https://github.com/matze/wastebin) ⭐ 839 | 🐛 17 | 🌐 Rust | 📅 2026-08-17: A minimalist pastebin service. (axum 0.8)
...
* [ReductStore](https://github.com/reductstore/reductstore) ⭐ 368 | 🐛 12 | 🌐 Rust | 📅 2026-08-18: A time series database for storing and managing large amounts of blob data. (axum 0.8.7)
...
* [qiluo-admin](https://github.com/chelunfu/qiluo_admin) ⭐ 231 | 🐛 1 | 🌐 Rust | 📅 2026-07-22 | Axum + SeaORM + JWT + Scheduled + Tasks + SnowId + Redis + Memory + VUE3 | DB: MySQL, Postgres, SQLite. (axum 0.8.9)
...
* [tower-mcp](https://github.com/joshrotenberg/tower-mcp) ⭐ 9 | 🐛 3 | 🌐 Rust | 📅 2026-08-19: Tower-native Model Context Protocol (MCP) implementation. (axum 0.8)
...
* [Svix](https://www.svix.com) ([repository](https://github.com/svix/svix-webhooks) ⭐ 3,360 | 🐛 57 | 🌐 Rust | 📅 2026-08-19): Enterprise-ready webhook service. (axum 0.7.9)
* [realworld-axum-sqlx](https://github.com/launchbadge/realworld-axum-sqlx) ⭐ 1,102 | 🐛 14 | 🌐 Rust | 📅 2023-12-30: A Rust implementation of the [Realworld](https://github.com/gothinkster/realworld) ⭐ 84,109 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-13 demo app spec using axum and [SQLx](https://crates.io/crates/sqlx). (axum 0.3.4) See [fork](https://github.com/davidpdrsn/realworld-axum-sqlx) ⭐ 238 | 🐛 2 | 🌐 Rust | 📅 2024-07-25 with newer dependencies. (axum 0.7.3)
