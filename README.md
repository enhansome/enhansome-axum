...
[repository](https://github.com/tokio-rs/axum) ⭐ 26,889 | 🐛 75 | 🌐 Rust | 📅 2026-08-15

This page contains a list of axum-related crates, project showcases, tutorials, videos, and other assorted items.

It started as a copy of the `ECOSYSTEM.md` file of the [repository of axum](https://github.com/tokio-rs/axum) ⭐ 26,889 | 🐛 75 | 🌐 Rust | 📅 2026-08-15 when it was [removed](https://github.com/tokio-rs/axum/pull/3737) ⭐ 26,889 | 🐛 75 | 🌐 Rust | 📅 2026-08-15. After a brief maintenance as part of the 📖 [Code Maven axum book](https://axum.code-maven.com/) it was moved to the 🎉 [awesome axum](https://github.com/szabgab/awesome-axum) ⭐ 109 | 🐛 0 | 📅 2026-05-07 repository.
...
* [loco.rs](https://github.com/loco-rs/loco) ⭐ 9,076 | 🐛 15 | 🌐 Rust | 📅 2026-08-16: A full stack Web and API productivity framework similar to Rails, based on axum.
...
* [crates.io](https://crates.io/) itself uses axum as a web library and [diesel](https://crates.io/crates/diesel) for database access.  [GitHub](https://github.com/rust-lang/crates.io/) ⭐ 3,674 | 🐛 115 | 🌐 Rust | 📅 2026-08-17  (axum 0.8.9)
...
* [wastebin](https://github.com/matze/wastebin) ⭐ 836 | 🐛 18 | 🌐 Rust | 📅 2026-08-10: A minimalist pastebin service. (axum 0.8)
...
* [ReductStore](https://github.com/reductstore/reductstore) ⭐ 366 | 🐛 17 | 🌐 Rust | 📅 2026-08-16: A time series database for storing and managing large amounts of blob data. (axum 0.8.7)
...
* [KeyCompute](https://github.com/aiqubits/keycompute) ⭐ 178 | 🐛 1 | 🌐 Rust | 📅 2026-08-16: KeyCompute is a high-performance, scalable, and ready-to-use AI computing power service platform. (axum 0.8; added on 2026.04.27)
...
* [Svix](https://www.svix.com) ([repository](https://github.com/svix/svix-webhooks) ⭐ 3,353 | 🐛 58 | 🌐 Rust | 📅 2026-08-13): Enterprise-ready webhook service. (axum 0.7.9)
* [realworld-axum-sqlx](https://github.com/launchbadge/realworld-axum-sqlx) ⭐ 1,102 | 🐛 14 | 🌐 Rust | 📅 2023-12-30: A Rust implementation of the [Realworld](https://github.com/gothinkster/realworld) ⭐ 84,087 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-13 demo app spec using axum and [SQLx](https://crates.io/crates/sqlx). (axum 0.3.4) See [fork](https://github.com/davidpdrsn/realworld-axum-sqlx) ⭐ 238 | 🐛 2 | 🌐 Rust | 📅 2024-07-25 with newer dependencies. (axum 0.7.3)
