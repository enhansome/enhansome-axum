...
[repository](https://github.com/tokio-rs/axum) ⭐ 27,031 | 🐛 75 | 🌐 Rust | 📅 2026-09-04

This page contains a list of axum-related crates, project showcases, tutorials, videos, and other assorted items.

It started as a copy of the `ECOSYSTEM.md` file of the [repository of axum](https://github.com/tokio-rs/axum) ⭐ 27,031 | 🐛 75 | 🌐 Rust | 📅 2026-09-04 when it was [removed](https://github.com/tokio-rs/axum/pull/3737) ⭐ 27,031 | 🐛 75 | 🌐 Rust | 📅 2026-09-04. After a brief maintenance as part of the 📖 [Code Maven axum book](https://axum.code-maven.com/) it was moved to the 🎉 [awesome axum](https://github.com/szabgab/awesome-axum) ⭐ 108 | 🐛 0 | 📅 2026-05-07 repository.
...
* [socketioxide](https://github.com/totodore/socketioxide) ⭐ 1,625 | 🐛 13 | 🌐 Rust | 📅 2026-09-01: An easy to use socket.io server implementation working as a `tower` layer/service.
...
* [crates.io](https://crates.io/) itself uses axum as a web library and [diesel](https://crates.io/crates/diesel) for database access.  [GitHub](https://github.com/rust-lang/crates.io/) ⭐ 3,690 | 🐛 112 | 🌐 Rust | 📅 2026-09-06  (axum 0.8.9)
...
* [wastebin](https://github.com/matze/wastebin) ⭐ 850 | 🐛 19 | 🌐 Rust | 📅 2026-08-27: A minimalist pastebin service. (axum 0.8)
...
* [freedit](https://github.com/freedit-org/freedit) ⭐ 313 | 🐛 13 | 🌐 Rust | 📅 2026-08-31: A forum powered by rust. (axum 0.8.7)
...
* [KeyCompute](https://github.com/aiqubits/keycompute) ⭐ 183 | 🐛 1 | 🌐 Rust | 📅 2026-08-29: KeyCompute is a high-performance, scalable, and ready-to-use AI computing power service platform. (axum 0.8; added on 2026.04.27)
...
* [Svix](https://www.svix.com) ([repository](https://github.com/svix/svix-webhooks) ⭐ 3,388 | 🐛 61 | 🌐 Rust | 📅 2026-09-04): Enterprise-ready webhook service. (axum 0.7.9)
* [realworld-axum-sqlx](https://github.com/launchbadge/realworld-axum-sqlx) ⭐ 1,105 | 🐛 14 | 🌐 Rust | 📅 2023-12-30: A Rust implementation of the [Realworld](https://github.com/gothinkster/realworld) ⭐ 84,195 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-26 demo app spec using axum and [SQLx](https://crates.io/crates/sqlx). (axum 0.3.4) See [fork](https://github.com/davidpdrsn/realworld-axum-sqlx) ⭐ 238 | 🐛 2 | 🌐 Rust | 📅 2024-07-25 with newer dependencies. (axum 0.7.3)
