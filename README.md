...
[repository](https://github.com/tokio-rs/axum) ⭐ 27,149 | 🐛 74 | 🌐 Rust | 📅 2026-09-15

This page contains a list of axum-related crates, project showcases, tutorials, videos, and other assorted items.

It started as a copy of the `ECOSYSTEM.md` file of the [repository of axum](https://github.com/tokio-rs/axum) ⭐ 27,149 | 🐛 74 | 🌐 Rust | 📅 2026-09-15 when it was [removed](https://github.com/tokio-rs/axum/pull/3737) ⭐ 27,149 | 🐛 74 | 🌐 Rust | 📅 2026-09-15. After a brief maintenance as part of the 📖 [Code Maven axum book](https://axum.code-maven.com/) it was moved to the 🎉 [awesome axum](https://github.com/szabgab/awesome-axum) ⭐ 108 | 🐛 0 | 📅 2026-05-07 repository.
...
* [loco.rs](https://github.com/loco-rs/loco) ⭐ 9,147 | 🐛 17 | 🌐 Rust | 📅 2026-09-16: A full stack Web and API productivity framework similar to Rails, based on axum.
...
* [spring-rs](https://github.com/spring-rs/spring-rs) ⭐ 1,005 | 🐛 27 | 🌐 Rust | 📅 2026-09-04: spring-rs is a microservice framework written in rust inspired by java's spring-boot, based on axum
* [tower-sessions](https://github.com/maxcountryman/tower-sessions) ⭐ 422 | 🐛 4 | 🌐 Rust | 📅 2026-08-05: Sessions as a `tower` and `axum` middleware.
...
* [crates.io](https://crates.io/) itself uses axum as a web library and [diesel](https://crates.io/crates/diesel) for database access.  [GitHub](https://github.com/rust-lang/crates.io/) ⭐ 3,699 | 🐛 114 | 🌐 Rust | 📅 2026-09-15  (axum 0.8.9)
...
* [wastebin](https://github.com/matze/wastebin) ⭐ 854 | 🐛 19 | 🌐 Rust | 📅 2026-09-15: A minimalist pastebin service. (axum 0.8)
...
* [Svix](https://www.svix.com) ([repository](https://github.com/svix/svix-webhooks) ⭐ 3,404 | 🐛 64 | 🌐 Rust | 📅 2026-09-16): Enterprise-ready webhook service. (axum 0.7.9)
* [realworld-axum-sqlx](https://github.com/launchbadge/realworld-axum-sqlx) ⭐ 1,105 | 🐛 14 | 🌐 Rust | 📅 2023-12-30: A Rust implementation of the [Realworld](https://github.com/gothinkster/realworld) ⭐ 84,211 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-26 demo app spec using axum and [SQLx](https://crates.io/crates/sqlx). (axum 0.3.4) See [fork](https://github.com/davidpdrsn/realworld-axum-sqlx) ⭐ 238 | 🐛 2 | 🌐 Rust | 📅 2024-07-25 with newer dependencies. (axum 0.7.3)
